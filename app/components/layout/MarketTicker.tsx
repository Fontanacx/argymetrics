 ...
 */
export default function MarketTicker({ rates, riesgoPais, commodities, cryptos, variations, stocks, internationalStocks, indices }: MarketTickerProps) {
  ...
  // 6. Add International Stocks
  if (internationalStocks) {
    internationalStocks.forEach((stock) => {
      items.push({
        label: stock.symbol.replace(/\.[A-Z]+$/, ""),
