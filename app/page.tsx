import { DollarSign, Activity, Clock, Wallet, Coins, TrendingUp, BarChart3, Globe } from "lucide-react";
...
import { fetchRiesgoPais, fetchInflacion, fetchInflacionHistory, getBandas, fetchBandasHistory, fetchReservas, fetchReservasHistory } from "@/lib/api/indicators";
  ...
  return (
    <div className="flex min-h-screen flex-col" style={{ background: "var(--bg-primary)" }}>
      ...
      <main id="main-content" className="mx-auto w-full max-w-7xl flex-1 px-4 py-6 sm:px-6 sm:py-8">
        ...
        {/* Acciones Internacionales section */}
        <section id="acciones-internacionales" className="mb-8">
          <div className="mb-4">
            <SectionHeader
