...
export const REVALIDATE_DOLLARS = 60;
...
export const REVALIDATE_INTERNATIONAL_STOCKS = 300;
export const REVALIDATE_RESERVAS = 3600;
export const BCRA_BASE = "https://api.bcra.gob.ar";
