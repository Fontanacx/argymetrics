...
export const INDICATOR_DEFINITIONS: Record<string, string> = {
  ...
  reservas:
    "Las Reservas Internacionales del BCRA son los activos en moneda extranjera (divisas, oro y DEG) que posee el Banco Central de la República Argentina. " +
    "Constituyen el principal respaldo externo del país y permiten intervenir en el mercado cambiario para estabilizar el tipo de cambio, " +
    "garantizar el pago de obligaciones internacionales y sostener la política monetaria. Se expresan en millones de dólares estadounidenses.",
  ...
  "meli.ba":
    "Mercado Libre (MELI) es la empresa de tecnología más valiosa de América Latina, líder en comercio electrónico y fintech. Opera el marketplace más grande de la región y su ecosistema de pagos Mercado Pago, siendo un referente del sector tech argentino a nivel global.",
  ...
  // International Stocks (NASDAQ / KRX)
  "aapl":
    "Apple Inc. (AAPL) es la empresa de tecnología más valiosa del mundo por capitalización bursátil. Diseña y fabrica el iPhone, Mac, iPad, Apple Watch y servicios como App Store, iCloud, Apple Music y Apple Pay. Cotiza en el NASDAQ y forma parte del Dow Jones y el S&P 500.",
  "nvda":
    "Nvidia Corporation (NVDA) es líder mundial en unidades de procesamiento gráfico (GPU) y computación acelerada. Sus chips impulsan la inteligencia artificial, los data centers, los videojuegos y los vehículos autónomos. Es una de las empresas de semiconductores más valiosas del mundo, cotizante del NASDAQ y componente del S&P 500.",
  "msft":
    "Microsoft Corporation (MSFT) es una de las mayores empresas de software del mundo. Desarrolla Windows, Office 365, Azure (nube), Xbox, LinkedIn y lidera la carrera de inteligencia artificial junto a OpenAI. Cotiza en el NASDAQ y forma parte del Dow Jones y del S&P 500.",
  "005930.ks":
    "Samsung Electronics Co., Ltd. (005930.KS) es la mayor empresa de Corea del Sur y líder global en semiconductores, smartphones (Galaxy), televisores y electrodomésticos. Sus chips de memoria son un termómetro clave de la industria tecnológica mundial. Cotiza en la Bolsa de Corea (KRX) y representa una parte significativa del índice KOSPI.",
  "tsla":
    "Tesla, Inc. (TSLA) es el principal fabricante mundial de vehículos eléctricos y sistemas de energía solar. Liderada por Elon Musk, produce los modelos S, 3, X, Y, el Cybertruck y baterías Powerwall. Cotiza en el NASDAQ y forma parte del S&P 500, siendo una de las acciones más operadas del mundo.",
  "spcx":
    "Space Exploration Technologies Corp. (SPCX) es la empresa aeroespacial fundada por Elon Musk en 2002. Diseña, fabrica y opera cohetes reutilizables (Falcon 9, Falcon Heavy, Starship) y la constelación de satélites Starlink para internet global. En 2026 salió a bolsa en el NASDAQ tras adquirir xAI (Grok) y X (Twitter), integrando sus verticales de Space, Connectivity y AI bajo una misma compañía.",
  "mu":
    "Micron Technology, Inc. (MU) es uno de los mayores fabricantes de semiconductores del mundo, especializado en chips de memoria DRAM, NAND flash y almacenamiento de alta velocidad. Sus productos son esenciales para data centers, inteligencia artificial, smartphones, PCs y vehículos autónomos. Cotiza en el NASDAQ y es un referente del sector de semiconductores junto a Nvidia, AMD e Intel.",
};
