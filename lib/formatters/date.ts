 ...
 *
 * Si el string es date-only ("YYYY-MM-DD") no tiene hora significativa, así que
 * devuelve solo la fecha. Además JS interpretaría medianoche UTC, que al pasar a
 * hora de Buenos Aires (UTC-3) retrocede al día anterior, por lo que anclamos a
 * mediodía para preservar el día correcto.
 */
